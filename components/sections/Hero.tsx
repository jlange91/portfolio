    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 w-full">
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            >
              ...
              Web Components, Design System & Fullstack
            </motion.p>
            ...
            >
              Je construis des interfaces Web qui tiennent sur la durée. Pendant 5 ans chez{" "}
              <strong className="dark:text-slate-200 text-slate-800 font-semibold">Fnac Darty</strong>,
              j&apos;ai appris qu&apos;un bon composant n&apos;est pas celui qui fonctionne — c&apos;est
              celui que trois équipes différentes peuvent utiliser sans t&apos;appeler.
            </motion.p>
            ...
            >
              {[
                { value: "~100k", label: "vues/jour" },
                { value: "8", label: "marchés" },
                { value: "30+", label: "composants" },
              ].map((stat) => (
                <div key={stat.label} className="text-center">
                  <dt className="text-2xl font-extrabold gradient-text leading-none">{stat.value}</dt>
            ...
            <motion.div variants={item} className="mt-5 flex items-center gap-4 flex-wrap">
              <a
                ...
                aria-label="Profil GitHub de Julien Lange (ouvre dans un nouvel onglet)"
              ...
              <a
                ...
                aria-label="Profil LinkedIn de Julien Lange (ouvre dans un nouvel onglet)"
                className="flex items-center gap-1.5 text-sm dark:text-slate-500 text-slate-500 dark:hover:text-accent hover:text-brand transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          >
            <div className="relative">
              ...
              <Image
                src="/img/Julien.png"
                alt="Julien Lange, développeur JavaScript senior freelance"
                width={380}
                height={460}
                priority
                className="
                  rounded-2xl object-cover
                  w-52 sm:w-64 lg:w-[380px]
        ...
        <motion.div
          ...
          aria-hidden="true"
        >
          <span className="font-mono text-[10px] dark:text-slate-700 text-slate-400 tracking-widest uppercase">scroll</span>
          <motion.div
            animate={{ y: [0, 5, 0] }}
            transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut" }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="dark:text-slate-700 text-slate-400">
