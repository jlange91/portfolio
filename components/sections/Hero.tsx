        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            >
              ...
              <span className="dark:text-slate-600 text-slate-300" aria-hidden="true">
                ·
              </span>{" "}
            ...
            >
              ...
              , j&apos;ai appris qu&apos;un bon composant n&apos;est pas celui qui fonctionne —
              c&apos;est celui que trois équipes différentes peuvent utiliser sans t&apos;appeler.
            </motion.p>
